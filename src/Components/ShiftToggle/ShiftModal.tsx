...
const SwitchShiftModal: React.FC<ShiftModalProps> = ({ isOpen, onConfirm, onCancel, state, setPin, setBalance, setRemainingAmount,errorMessage }) => {
    ...
    return (
        <CustomModal
            ...
            title={'Switch Shift Confirmation'}
            content={
                <div>
                    <div className='mt-5'>
                            <Form>
                                <Form.Item
                                    label="Your Shift Balance"
                    ...
                    <div className='pin'>
                        ...
                        <label className='mt-3'>Enter Your PIN</label>
                    </div>
